...
f21 = '../../Auncel/eval/Auncel_Latency_sift10M_100_5.log'
f22 = '../../LAET/benchs/learned_termination/LAET_Latency_sift10M_100_5.log'
f23 = '../../faiss/eval/Faiss_Latecy_sift10M_100_5.log'

f31 = '../../Auncel/eval/Auncel_Latency_sift10M_100_1.log'
f32 = '../../LAET/benchs/learned_termination/LAET_Latency_sift10M_100_1.log'
f33 = '../../faiss/eval/Faiss_Latecy_sift10M_100_1.log'

logs = [[f11,f12,f13], [f21, f22, f23], [f31,f32,f33]]
...
# data
sys_name = 'Auncel'
datasets = ['Error-10%', 'Error-5%', 'Error-1%']

lat_slow_elp = np.array(lat_slow_elp)
lat_slow_laet = np.array(lat_slow_laet)
lat_slow_faiss = np.array(lat_slow_faiss)
lat_slow_laet /= lat_slow_elp
lat_slow_faiss /= lat_slow_elp
lat_slow_elp /= lat_slow_elp
