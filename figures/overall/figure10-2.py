...
f21 = '../../Auncel/eval/Auncel_Latency_deep10M_100_10.log'
f22 = '../../LAET/benchs/learned_termination/LAET_Latency_deep10M_100_10.log'
f23 = '../../faiss/eval/Faiss_Latecy_deep10M_100_10.log'

f31 = '../../Auncel/eval/Auncel_Latency_gist_100_10.log'
f32 = '../../LAET/benchs/learned_termination/LAET_Latency_gist_100_10.log'
f33 = '../../faiss/eval/Faiss_Latecy_gist_100_10.log'

f41 = '../../Auncel/eval/Auncel_Latency_text_100_10.log'
f42 = '../../LAET/benchs/learned_termination/LAET_Latency_text_100_10.log'
f43 = '../../faiss/eval/Faiss_Latecy_text_100_10.log'

logs = [[f11,f12,f13], [f21, f22, f23], [f31,f32,f33], [f41,f42,f43]]
...
sys_name = 'Auncel'
datasets = ['SIFT10M', 'DEEP10M', 'GIST1M', 'TEXT10M']
...
# Plot bars
# top
b1 = ax1.bar(indexes[0], lat_slow_elp, width, label=sys_name, edgecolor='black',zorder=3)
b2 = ax1.bar(indexes[1], lat_slow_laet, width, label='LAET', edgecolor='black',zorder=3)
b3 = ax1.bar(indexes[2], lat_slow_faiss, width, label='Faiss', edgecolor='black',zorder=3)

ax1.set_ylim(bottom=0, top=30)

ax1.set_ylabel('Avg. Slowdown')
x_ticks = [0.2*i+0.12+width for i in range(num_datasets)]
y_ticks = [i for i in range(0, 35, 5)]
